...
if __name__ == "__main__":
    ...
    predictor = Predictor()
    subs, audio_file_path, voice_probabilities = predictor.predict_single_pass(video_file_path, srt_file_path)
    ...
    subs_list, subs, voice_probabilities = predictor.predict_dual_pass(video_file_path, srt_file_path, stretch=False)
